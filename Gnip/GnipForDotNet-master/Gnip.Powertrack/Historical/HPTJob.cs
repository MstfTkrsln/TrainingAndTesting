...
namespace Gnip.Powertrack.Historical
{
    public class HptJob
    {
        ...
        public List<HptJobInfo> GetJobs()
        {
            ...
            try
            {
                //var postcontent = "{\"publisher\": \"twitter\",\"streamType\": \"track\",\"dataFormat\": \"activity_streams\",\"fromDate\": \"201601200000\",\"toDate\": \"201601250000\",\"title\": \"historicalJob1\",\"rules\":[{\"tag\":\"test\",\"value\":\"beşiktaş\"}]}";
