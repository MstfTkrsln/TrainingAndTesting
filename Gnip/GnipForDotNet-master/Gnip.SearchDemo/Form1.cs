...
namespace Gnip.SearchDemo
{
    public partial class frmSearchAndUsageDemo : Form
    {
        ...
        {
            InitializeComponent();
            tbAccountName.Text = "InterpressMedia";
            tbUsername.Text = "hamzakilic@interpress.com";
            tbPassword.Text = "syshmzsys203-";
            tbStreamName.Text = "prod";
        ...
        {
            tbResults.Text += activity.verb.ToUpper()+" " +activity.postedTime + " " +   activity.link +"  "+ Environment.NewLine;
