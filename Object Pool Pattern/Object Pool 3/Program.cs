...
namespace ObjectPooling
{
    internal class Program
    {
        ...
        public sealed class PoolManager
        {
            ...
            private static readonly Employee objLock = new Employee();
            ...
            public void CreateObjects(Employee obj)
            {
                Employee _obj = obj;
                objCount = 0;
                poolQueue.Clear();
            ...
            public bool AddObject(Employee obj)
            {
            ...
            /// <returns>The object if success, null otherwise</returns>
            public object ReleaseObject(Employee obj)
            {
                if (objCount == 0)
                    return null;
